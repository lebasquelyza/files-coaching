...
// Bloque l'accès si le token HMAC SHA-256 est absent/invalidé/expiré.
// Token attendu en query ?t=... OU header x-fc-token: ...
    ...
    if (payloadB64 && sigB64) {
      ...
      if (expectedSigB64 === sigB64) {
        ...
        if (typeof payload.exp === 'number' && now <= payload.exp) {
          if (!payload.aud || payload.aud === 'questionnaire') ok = true;
        }
      }
    }
  } catch (_) {
...
<div class="card">
  <h1>Accès refusé</h1>
  <p>Ce questionnaire n’est accessible que depuis l’application Files Coaching.</p>
  <p><a href="https://appli.files-coaching.com">Ouvrir l’application</a></p>
</div>`;
